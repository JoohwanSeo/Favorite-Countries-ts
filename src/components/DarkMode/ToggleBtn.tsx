...
const ToggleBtn = ({}: ToggleBtnProps) => {
  ...
  <button 
  onClick={toggleTheme}
  className="m-2 px-4 py-2 bg-black text-[#fcffff] dark:text-[#000000] rounded-md hover:bg-gray dark:bg-white dark:hover:bg-white-800 transition-colors duration-300"
  >
    DarkMode
  </button>) ;
};
